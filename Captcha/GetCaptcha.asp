...
Const CAPTCHA_CHARACTER_FACTOR = 15  '// How many pixels are we moving each new character from left?
Const CAPTCHA_BOX_BORDER = "border: 0px solid #ccc;"   '// Style the div box holding the CAPTCHA.
Const CAPTCHA_BOX_WIDTH = 120              '// Width. This value should balance the number of characters and size.
Const CAPTCHA_BOX_HEIGHT = 25               '// Same as above.
...
Function RandomString(iMax)
    ...
    For i = 1 To iMax
        sTmp = sTmp & Chr(97 + RandomNumber(26))    
        '// Return a random number between 97 and 122, ascii values for [a-z]
    Next
